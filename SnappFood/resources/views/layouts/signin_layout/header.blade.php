    ...
    <div class="w-[70%] flex flex-wrap justify-between items-center mx-auto h-[90px]">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-white dark:border-gray-700">
                ...
                <li>
                    <a href="/login"
                       class="block text-2xl py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-00 md:dark:hover:text-orange-400 dark:hover:bg-gray-700 dark:hover:text-orange-500 md:dark:hover:bg-transparent">login</a>
                </li>
            </ul>
        </div>
    </div>
