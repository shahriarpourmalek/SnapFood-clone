...
@section('content')
    ...
    <div class="mx-auto mt-24 w-[70%]">
        ...
        <form action="{{route('admin.banner-manager.store')}}" method="post"  enctype="multipart/form-data">
            @csrf
            @method('POST')
            ...
            <div class="flex flex-col ">
                ...
                <input name="banner_image" type="file" class="h-[50px] bg-orange-100 rounded-lg w-[300px]">
            </div>
