...
<div class="mx-auto pt-3 w-[300px] h-[60px] bg-orange-400 rounded-lg">
    <a href="{{route('admin.banner-manager.create')}}" class="text-[20px] text-white flex flex-row justify-center">
        Create  Banner
    </a>
</div>
                    ...
                    <div class="w-full px-4 md:w-15 xl:w-1/3">
                        <div class="mb-10 overflow-hidden rounded-lg bg-white">
                            ...
                            <div class="p-8 text-center sm:p-9 md:p-7 xl:p-9">
                                ...
                                <a href="{{route('admin.banner-manager.show',$banner->id)}}"
                                   class="text-body-color bg-green-300 hover:border-primary hover:bg-primary inline-block rounded-full border border-[#E5E7EB] py-2 w-[150px] text-base font-medium transition hover:text-white">
                                    edit details
                                </a>
                            </div>
                        </div>
