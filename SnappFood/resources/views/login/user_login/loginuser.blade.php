...
@extends('login_layout.main')


@section('content')
    <h2 class="text-4xl flex justify-center font-bold mb-6 text-gray-900">User's Login</h2>
    ...
    <div class="mx-auto mt-24 w-[70%]">
        <form action="#" method="post">
            ...
            <div class="flex flex-col ">
                ...
                <input name="seller_email" type="text" class="h-[50px] bg-orange-100 rounded-lg">
            </div>
